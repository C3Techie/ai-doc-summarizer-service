...
export const UNAUTHORIZED_ACCESS = 'You are not authorized to perform this action.';
...
// ==================== DOCUMENT MESSAGES ====================
export const DOCUMENT_UPLOADED = 'Document uploaded and text extracted successfully.';
export const DOCUMENT_UPLOAD_FAILED = 'Document upload failed. Please try again.';
export const DOCUMENT_UPLOAD_FAILED_TEXT_EXTRACTION = 'Document upload failed during text extraction.';
export const DOCUMENT_UPLOAD_FAILED_DATABASE_SAVE = 'Document upload failed during database save.';
...
export const ANALYSIS_ALREADY_COMPLETED = 'Analysis for this document has already been completed.';
export const ANALYSIS_FAILED = 'Document analysis failed. Please try again.';
export const ANALYSIS_IN_PROGRESS = 'Document analysis is currently in progress.';
...
export const TEXT_TRUNCATED = 'Document text truncated to maximum allowed length.';

// ==================== OPENROUTER/LLM MESSAGES ====================
export const OPENROUTER_API_KEY_MISSING = 'OPENROUTER_API_KEY is not configured.';
export const LLM_ANALYSIS_SUCCESS = 'LLM analysis completed successfully.';
export const LLM_ANALYSIS_FAILED = 'Failed to analyze document with OpenRouter LLM.';
export const LLM_RESPONSE_INVALID = 'LLM response is missing required fields.';

// ==================== VALIDATION MESSAGES ====================
export const FILE_TOO_LARGE = 'File size exceeds the maximum allowed limit of 5MB.';
export const INVALID_FILE_TYPE = 'Invalid file type. Only PDF and DOCX files are allowed.';
